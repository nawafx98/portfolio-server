...
resume_template = PromptTemplate(
    ...
    template=''' Analyze the resume, referred to as {pdf_text}, and provide integrated feedback that is deeply relevant to its content. Throughout your analysis, reference the individual, whose name is provided in the resume, to personalize the feedback. Focus on creating a unified and coherent paragraph that interweaves insights from the Professional Summary, Work Experience, Skills, ATS Optimization, and General Feedback. Your response should address the unique strengths and areas for improvement in the resume, making sure the advice is directly tailored to the experiences and qualifications of the individual named in the resume. The only goal is to provide clear, actionable advice and specific recommendations without going deep in the feedback, try to focus on the adctionable advices and recommendations. These should be aimed at helping the individual enhance their resume, better highlight their skills and achievements, and address any areas that need improvement, thereby aiding their professional advancement.
    '''
)
